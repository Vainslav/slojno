...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Flexbox)\n/* harmony export */ });\n/* harmony import */ var _stores_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../stores/store */ \"./src/stores/store.js\");\n\nconst styles = {\n  flex_flow: 'flex-flow',\n  justify_content: 'justify-content',\n  align_items: 'align-items',\n  align_content: 'align-content'\n};\nfunction Flexbox(data, parse) {\n  const element = document.createElement('div');\n  let children = [];\n  const setData = newData => {\n    console.log('setting data');\n    children.forEach(child => child.destroy);\n    element.innerHTML = \"\";\n    children = [];\n    for (let childData of data.data) {\n      console.log('creating chlid');\n      const child = parse(childData);\n      children.push(child);\n      element.appendChild(child.element);\n    }\n    element.className = 'flex';\n    if (newData.classes) {\n      for (let className of newData.classes) element.className += className;\n    }\n    let styleStr = \"\";\n    for (let style in styles) {\n      if (style in newData) styleStr += `${styles[style]}: ${newData[style]};`;\n    }\n    element.setAttribute('style', styleStr);\n  };\n  const unsubscribe = _stores_store__WEBPACK_IMPORTED_MODULE_0__.StoreManager.onChange({\n    ...data,\n    data: []\n  }, setData);\n  return {\n    element,\n    destroy: () => {\n      unsubscribe();\n      children.forEach(child => child.destroy());\n    }\n  };\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/components/flexbox.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Image)\n/* harmony export */ });\n/* harmony import */ var _image_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./image.css */ \"./src/components/image.css\");\n/* harmony import */ var _stores_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../stores/store */ \"./src/stores/store.js\");\n\n\nfunction Image(data, parse) {\n  const element = document.createElement('div');\n  const image = document.createElement('img');\n  element.appendChild(image);\n  const setData = data => {\n    image.setAttribute('src', data.src);\n    image.setAttribute('alt', data.alt);\n    element.className = 'image';\n    if (data.classes) {\n      for (let className of data.classes) element.className += className;\n    }\n  };\n  const unsubscribe = _stores_store__WEBPACK_IMPORTED_MODULE_1__.StoreManager.onChange({\n    src: data.src,\n    alt: data.alt\n  }, setData);\n  setData(data);\n  return {\n    element,\n    destroy: unsubscribe\n  };\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/components/image.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Text)\n/* harmony export */ });\n/* harmony import */ var _text_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./text.css */ \"./src/components/text.css\");\n/* harmony import */ var _stores_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../stores/store */ \"./src/stores/store.js\");\n\n\nfunction Text(data, parse) {\n  const element = document.createElement('span');\n  const setData = data => {\n    element.innerText = data.content;\n    element.className = 'text';\n    if (data.classes) {\n      for (let className of data.classes) element.className += className;\n    }\n  };\n  const unsubscribe = _stores_store__WEBPACK_IMPORTED_MODULE_1__.StoreManager.onChange({\n    content: data.content,\n    classes: data.classes\n  }, setData);\n  return {\n    element,\n    destroy: unsubscribe\n  };\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/components/text.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _stores_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stores/store */ \"./src/stores/store.js\");\n\n\n(async () => {\n  _stores_store__WEBPACK_IMPORTED_MODULE_1__.StoreManager.dispatch('$page.redirect(content)');\n})();\n\n//# sourceURL=webpack://my-webpack-project/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ parse)\n/* harmony export */ });\n/* harmony import */ var _components_text__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/text */ \"./src/components/text.js\");\n/* harmony import */ var _components_image__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/image */ \"./src/components/image.js\");\n/* harmony import */ var _components_button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/button */ \"./src/components/button.js\");\n/* harmony import */ var _components_flexbox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/flexbox */ \"./src/components/flexbox.js\");\n/* harmony import */ var _components_activity__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/activity */ \"./src/components/activity.js\");\n\n\n\n\n\nconst components = {\n  Text: _components_text__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\n  Image: _components_image__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  Button: _components_button__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\n  Flexbox: _components_flexbox__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n  Activity: _components_activity__WEBPACK_IMPORTED_MODULE_4__[\"default\"]\n};\nfunction parse(tree) {\n  const data = {};\n  for (let key in tree) {\n    if (key.match(/web-/)) {\n      data[key.match(/web-(.*)/)[1]] = tree[key];\n      continue;\n    }\n    if (key.match(/.*-/)) continue;\n    if (key.match(/web/)) {\n      data[key.match(/web-(.*)/)[1]] = tree[key];\n      continue;\n    }\n    if (tree[`web-${key}`]) continue;\n    data[key] = tree[key];\n  }\n  return components[data.type](data, parse);\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/parser.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n// Imports\n\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, `.image {\r\n  display: flex;\r\n  justify-content: center;\r\n  border: 2px solid black;\r\n}\r\n\r\n.image img {\r\n  object-fit: contain;\r\n}\r\n`, \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://my-webpack-project/./src/components/image.css?./node_modules/css-loader/dist/cjs.js");

/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js!./src/components/text.css":
/*!***********************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/components/text.css ***!
  \***********************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n// Imports\n\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, `.text {\r\n  color: blue;\r\n}\r\n\r\n.text.bold {\r\n  font-weight: bold;\r\n  color: black;\r\n}\r\n`, \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://my-webpack-project/./src/components/text.css?./node_modules/css-loader/dist/cjs.js");
